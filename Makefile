...
#    Updated: 2022/05/21 03:44:52 by vwildner         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC		= readline.c wip_lexer.c print_error.c execute.c utils.c execute_system.c redir.c utils2.c signal.c prompt.c here_doc.c expand.c tokens.c
